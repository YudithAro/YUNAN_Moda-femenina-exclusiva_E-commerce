        ...
        <section id="catalogo" className="container mx-auto px-4 py-16 flex flex-col lg:flex-row gap-12 max-w-[1400px]">
          ...
          <div className="flex-1">
            ...
            {loading ? (
              ...
              <div className="col-span-full text-center py-32 space-y-6 bg-[#0a0508]/30 rounded-[3rem] border border-white/5 backdrop-blur-md">
                <Sparkles className="h-12 w-12 text-[#cfa873]/50 mx-auto" />
                <p className="text-gray-400 font-serif text-xl">No se encontraron piezas que coincidan con tu búsqueda.</p>
                <Button variant="outline" onClick={() => {setSearch(""); setCategory("all"); setMinPrice(""); setMaxPrice("");}} className="border-[#cfa873]/30 text-[#cfa873] hover:bg-[#cfa873]/10 rounded-full px-8 tracking-widest uppercase text-[10px]">Ver Todo</Button>
              </div>
