    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0a]">
      ...
      >
        ...
        <div className="hidden md:flex md:w-1/2 p-12 flex-col items-center justify-center relative bg-gradient-to-b from-[#111111] to-[#1a0f14] border-r border-white/5">
          ...
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-zinc-400 text-sm max-w-xs mx-auto leading-relaxed">
              Únete a nuestra comunidad exclusiva y accede a las últimas tendencias en moda premium.
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-[#0d0d0d]">
          <div className="mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3 font-serif">Crear Cuenta</h1>
            <p className="text-zinc-400">Únete a YUNAN y comienza a brillar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold tracking-wider text-zinc-400 uppercase" htmlFor="name">
                Nombre Completo
              </label>
            ...
            <Button 
              type="submit" 
              disabled={isLoading}
              className="w-full h-14 mt-2 bg-gradient-to-r from-pink-600 to-pink-500 hover:from-pink-500 hover:to-pink-400 text-white font-bold tracking-wider rounded-xl transition-all shadow-[0_0_20px_rgba(219,39,119,0.3)] hover:shadow-[0_0_30px_rgba(219,39,119,0.5)] group"
            >
          ...
          <div className="mt-8 text-center text-sm text-zinc-500">
            ¿Ya tienes una cuenta? <Link href="/auth/login" className="text-pink-500 hover:text-pink-400 font-bold ml-1 transition-colors">Inicia sesión aquí</Link>
          </div>
        </div>
      </motion.div>
    </div>
